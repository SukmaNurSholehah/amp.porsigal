 ...
 * @author naila
 */
public class pnAnggota extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pnAnggota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
